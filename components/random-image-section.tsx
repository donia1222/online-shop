  ...
  return (
    <section className="py-6" style={{ backgroundColor: sectionBg }}>
      <div className="container mx-auto px-4">
        ...
        {/* Tarjeta con borde */}
        <div className="rounded-3xl bg-white border border-[#E5E5E5] shadow-sm p-5 sm:p-7">
          ...
          <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-2 -mx-1 px-1 [scrollbar-width:thin]">
